...
public class NativeKeyboardInputField
        : Selectable,
        ...
        ILayoutElement
{
    ...
    protected NativeKeyboardInputField()
    {
    ...
    private void ActivateInputFieldInternal()
    {
        ...
        {            
            ...
            {
                if (NativeKeyboardManager.GetManager().IsShowKeyboard == false)
                {
                    NativeKeyboardManager.GetManager().ShowAndroidNativeKeyboard(text, (string changedText) =>
                    {
                        text = changedText;                        
                        MoveTextEnd(false);
                    },
...
[CustomEditor(typeof(NativeKeyboardInputField), true)]
public class NativeKeyboardInputFieldEditor : CustomSelectableEditor
{
...
public class CustomSelectableEditor : Editor
{
    ...
    private static List<CustomSelectableEditor> s_Editors = new List<CustomSelectableEditor>();
    ...
    {
        return GetType() != typeof(CustomSelectableEditor);
    }
    ...
    private static string BuildAnimationPath(Selectable target)
    {
        ...
        // calculate path
        var animPath = new System.Text.StringBuilder();
